...
curl "https://aquadx.net/d/wacca/00/all-music.json" -o "$DIR/wacca/music.json"
curl "https://aquadx.net/d/chu3/00/all-items.json" -o "$DIR/chu3/items.json"
curl "https://aquadx.net/d/ongeki/00/all-items.json" -o "$DIR/ongeki/items.json"
